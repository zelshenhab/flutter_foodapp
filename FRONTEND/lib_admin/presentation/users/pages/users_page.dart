    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            TextField(controller: nameCtrl, decoration: const InputDecoration(hintText: 'Имя')),
            const SizedBox(height: 8),
            TextField(controller: phoneCtrl, decoration: const InputDecoration(hintText: 'Телефон')),
            const SizedBox(height: 8),
